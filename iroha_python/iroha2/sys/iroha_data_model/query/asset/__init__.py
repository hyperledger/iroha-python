...
FindAssetsByAccountIdAndAssetDefinitionId = Struct[("account_id", "iroha_data_model.expression.EvaluatesTo"), ("asset_definition_id", "iroha_data_model.expression.EvaluatesTo")]

FindAssetsByAssetDefinitionId = Struct[("asset_definition_id", "iroha_data_model.expression.EvaluatesTo")]

FindAssetsByDomainName = Struct[("domain_name", "iroha_data_model.expression.EvaluatesTo")]

FindAssetsByDomainNameAndAssetDefinitionId = Struct[("domain_name", "iroha_data_model.expression.EvaluatesTo"), ("asset_definition_id", "iroha_data_model.expression.EvaluatesTo")]
