...
SetSettingValue = _reflection.GeneratedProtocolMessageType('SetSettingValue', (_message.Message,), dict(
...
CallEngine = _reflection.GeneratedProtocolMessageType('CallEngine', (_message.Message,), dict(
