...
EngineReceiptsResponse = _reflection.GeneratedProtocolMessageType('EngineReceiptsResponse', (_message.Message,), dict(
...
HealthcheckData = _reflection.GeneratedProtocolMessageType('HealthcheckData', (_message.Message,), dict(
