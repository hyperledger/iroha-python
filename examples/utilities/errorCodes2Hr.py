...
error_codes_per_command = {
    ...
    'AddAssetQuantity': resultOf_AddAssetQuantity_and_TransferAsset_ToHumanReadable,
    'CreateAccount': resultOf_CreateAccount_ToHumanReadable,
    'TransferAsset': resultOf_TransferAsset_ToHumanReadable,
    'GrantPermission': resultOf_GrantPermission_ToHumanReadable,
    'SetAccountDetail': resultOf_SetAccountDetail_ToHumanReadable,
    'SetAccountQuorum': resultOf_SetAccountQuorum_ToHumanReadable,
    'GetAccountAssetTransactions': resultOf_GetAccountAssetTransactions_ToHumanReadable,
    'CompareAndSetAccountDetail': resultOf_CompareAndSetAccountDetail_ToHumanReadable,
    'CreateRole': resultOf_CreateRole_ToHumanReadable,
    'AppendRole': resultOf_AppendRole_ToHumanReadable,
    'AddPeer': resultOf_AddPeer_ToHumanReadable,
    'RemovePeer': resultOf_RemovePeer_ToHumanReadable,
    'AddSignatory': resultOf_AddSignatory_ToHumanReadable,
    'RemoveSignatory': resultOf_RemoveSignatory_ToHumanReadable,
}
