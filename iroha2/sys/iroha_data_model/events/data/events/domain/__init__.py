...
DomainEvent = make_enum("DomainEvent", [("Account", get_class("iroha_data_model.events.data.events.account.AccountEvent")), ("AssetDefinition", get_class("iroha_data_model.events.data.events.asset.AssetDefinitionEvent")), ("Created", get_class("iroha_data_model.domain.Domain")), ("Deleted", get_class("iroha_data_model.domain.Id")), ("MetadataInserted", get_class("iroha_data_model.events.data.events.MetadataChanged")), ("MetadataRemoved", get_class("iroha_data_model.events.data.events.MetadataChanged"))], typing.Union[get_class("iroha_data_model.events.data.events.account.AccountEvent"), get_class("iroha_data_model.events.data.events.asset.AssetDefinitionEvent"), get_class("iroha_data_model.domain.Domain"), get_class("iroha_data_model.domain.Id"), get_class("iroha_data_model.events.data.events.MetadataChanged"), get_class("iroha_data_model.events.data.events.MetadataChanged")])
