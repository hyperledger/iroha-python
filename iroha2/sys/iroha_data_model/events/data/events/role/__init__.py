...
RoleEvent = make_enum("RoleEvent", [("Created", get_class("iroha_data_model.role.Role")), ("Deleted", get_class("iroha_data_model.role.Id")), ("PermissionRemoved", get_class("iroha_data_model.events.data.events.role.PermissionRemoved"))], typing.Union[get_class("iroha_data_model.role.Role"), get_class("iroha_data_model.role.Id"), get_class("iroha_data_model.events.data.events.role.PermissionRemoved")])
