...
NewParameterBox = make_struct("NewParameterBox", [("parameter", "iroha_data_model.expression.EvaluatesTo")])
...
SetParameterBox = make_struct("SetParameterBox", [("parameter", "iroha_data_model.expression.EvaluatesTo")])
